"""apply schema.sql (v2 canonical schema, 28 tables)

Revision ID: 5fdfe1626481
Revises:
...
def downgrade() -> None:
    op.execute("DROP TABLE IF EXISTS recovery_batches CASCADE")
    op.execute("DROP TABLE IF EXISTS ops_alerts CASCADE")
    op.execute("DROP TABLE IF EXISTS recovery_explanations CASCADE")
    op.execute("DROP TABLE IF EXISTS recovery_outcomes CASCADE")
    op.execute("DROP TABLE IF EXISTS recovery_attempts CASCADE")
    op.execute("DROP TABLE IF EXISTS recovery_tokens CASCADE")
    op.execute("DROP TABLE IF EXISTS message_templates CASCADE")
    op.execute("DROP TABLE IF EXISTS policy_bounds CASCADE")
    op.execute("DROP TABLE IF EXISTS revenue_at_risk CASCADE")
    ...
    op.execute("DROP TABLE IF EXISTS reprocessing_runs CASCADE")
    op.execute("DROP TABLE IF EXISTS unmapped_fields CASCADE")
    op.execute("DROP TABLE IF EXISTS failure_taxonomy CASCADE")
    op.execute("DROP TABLE IF EXISTS value_mappings CASCADE")
